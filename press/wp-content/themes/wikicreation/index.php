...
<html lang="fr">
  <head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="<?php echo THEME_DIR ?>/icons/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="<?php echo THEME_DIR ?>/icons/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo THEME_DIR ?>/icons/favicon-16x16.png">
